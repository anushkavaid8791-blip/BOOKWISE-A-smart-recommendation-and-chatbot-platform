 ...
 * Pass an `onClick` handler that kicks off your OAuth flow
 * (e.g. redirect to `${API_BASE_URL}/api/auth/google`).
 */
function GoogleButton({ onClick, loading = false }) {
  return (
    ...
    >
      ...
      <span className="google-btn__arrow" aria-hidden="true">→</span>
    </button>
  );
}
